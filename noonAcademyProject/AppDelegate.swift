...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if let userNameCheck = UserDefaults.standard.object(forKey: "userNameFromGoogleSignin") as? String,
        !userNameCheck.isEmpty,
            let userEmailId = UserDefaults.standard.object(forKey: "userEmailIdFromGoogleSignin") as? String,
        !userEmailId.isEmpty{// Cross Checking data for logged in state
            debugPrint("User already logged in. Load home page.")
            ...
            debugPrint("User not found. Try to init and login.")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "noonAcademyProject")
